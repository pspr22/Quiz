...
public class Inventors extends AppCompatActivity {
    ...
    DatabaseReference myref = database.getReference("Inventors");
    DatabaseReference ref = database.getReference("Inventors");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timer = findViewById(R.id.ITimer);
        Question = findViewById(R.id.IQuestion);
        a = findViewById(R.id.Ia);
        b = findViewById(R.id.Ib);
        c = findViewById(R.id.Ic);
        d = findViewById(R.id.Id);
        Quit = findViewById(R.id.IQuit);
        Next = findViewById(R.id.INext);
        fix = findViewById(R.id.fixi);
        mediaPlayer = MediaPlayer.create(Inventors.this,R.raw.sound);
        ...
        a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                b.setBackground(ContextCompat.getDrawable(Inventors.this, textview_shape));
                c.setBackground(ContextCompat.getDrawable(Inventors.this, textview_shape));
                d.setBackground(ContextCompat.getDrawable(Inventors.this, textview_shape));
                userAnswer ="a";
                resultCode = 1;
            }
        });
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                userAnswer ="b";
                a.setBackground(ContextCompat.getDrawable(Inventors.this, textview_shape));
                c.setBackground(ContextCompat.getDrawable(Inventors.this, textview_shape));
                d.setBackground(ContextCompat.getDrawable(Inventors.this, textview_shape));
                resultCode = 2;
        ...
        myref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(QNumber < count){
                    ...
                    Toast.makeText(Inventors.this, "You Answered All Questions", Toast.LENGTH_SHORT).show();
                    quit();
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Inventors.this, "Error Occured", Toast.LENGTH_SHORT).show();
    ...
    public void quit(){
        ...
        Intent intent = new Intent(Inventors.this, Result.class);
