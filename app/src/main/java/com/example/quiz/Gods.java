...
public class Gods extends AppCompatActivity {
    ...
    DatabaseReference myref = database.getReference("Gods");
    DatabaseReference ref = database.getReference("Gods");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(Gods.this,R.raw.sound);

        timer = findViewById(R.id.GTimer);
        Question = findViewById(R.id.GQuestion);
        a = findViewById(R.id.Ga);
        b = findViewById(R.id.Gb);
        c = findViewById(R.id.Gc);
        d = findViewById(R.id.Gd);
        Quit = findViewById(R.id.GQuit);
        Next = findViewById(R.id.GNext);
        fix = findViewById(R.id.fixg);
        ...
        a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                b.setBackground(ContextCompat.getDrawable(Gods.this, textview_shape));
                c.setBackground(ContextCompat.getDrawable(Gods.this, textview_shape));
                d.setBackground(ContextCompat.getDrawable(Gods.this, textview_shape));
                userAnswer ="a";
                resultCode = 1;
            }
        });
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                userAnswer ="b";
                a.setBackground(ContextCompat.getDrawable(Gods.this, textview_shape));
                c.setBackground(ContextCompat.getDrawable(Gods.this, textview_shape));
                d.setBackground(ContextCompat.getDrawable(Gods.this, textview_shape));
                resultCode = 2;
        ...
        myref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(QNumber < count){
                    ...
                    Toast.makeText(Gods.this, "You Answered All Questions", Toast.LENGTH_SHORT).show();
                    quit();
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Gods.this, "Error Occured", Toast.LENGTH_SHORT).show();
    ...
    public void quit(){
        ...
        Intent intent = new Intent(Gods.this, Result.class);
